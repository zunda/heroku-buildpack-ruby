...
class LanguagePack::Rails3 < LanguagePack::Rails2
  ...
  def self.use?
    Skylight.instrument "rails3.use" do
      if gemfile_lock?
  ...
  def default_process_types
    Skylight.instrument "rails3.default_process_types" do
...
private
  ...
  def run_assets_precompile_rake_task
    Skylight.instrument "rails3.run_assets_precompile_rake_task" do
  ...
  def setup_database_url_env
    Skylight.instrument "rails3.setup_database_url_env" do
