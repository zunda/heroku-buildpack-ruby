...
class LanguagePack::Rails4 < LanguagePack::Rails3
  ...
  def self.use?
    Skylight.instrument "rails4.use" do
      if gemfile_lock?
  ...
  def default_process_types
    Skylight.instrument "rails4.default_process_types" do
      super.merge({
  ...
  def build_bundler
    Skylight.instrument "rails4.build_bundler" do
      super
  ...
  def check_for_rails_gems
    Skylight.instrument "rails4.check_for_rails_gems" do
...
WARNING
  ...
  def run_assets_precompile_rake_task
    Skylight.instrument "rails4.run_assets_precompile_rake_task" do
