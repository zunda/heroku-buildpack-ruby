...
class LanguagePack::Rails2 < LanguagePack::Ruby
  ...
  def default_config_vars
    Skylight.instrument "rails2.default_config_vars" do
      super.merge({
  ...
  def default_process_types
    Skylight.instrument "rails2.default_process_types" do
  ...
  def compile
    Skylight.instrument "rails2.compile" do
      super
      install_plugins
    end
  end
...
private
  ...
  def install_plugins
    Skylight.instrument "rails2.install_plugins" do
      if plugins.any?
